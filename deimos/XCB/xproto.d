...
const int XCB_BUTTON_RELEASE = 5;
...
const int XCB_GRAPHICS_EXPOSURE = 13;
...
const int XCB_VISIBILITY_NOTIFY = 15;
...
const int XCB_CREATE_NOTIFY = 16;
...
const int XCB_DESTROY_NOTIFY = 17;
...
const int XCB_REPARENT_NOTIFY = 21;
...
const int XCB_CONFIGURE_NOTIFY = 22;
...
const int XCB_CONFIGURE_REQUEST = 23;
...
const int XCB_GRAVITY_NOTIFY = 24;
...
const int XCB_RESIZE_REQUEST = 25;
...
const int XCB_CIRCULATE_NOTIFY = 26;
...
const int XCB_CIRCULATE_REQUEST = 27;
...
const int XCB_PROPERTY_NOTIFY = 28;
...
const int XCB_SELECTION_CLEAR = 29;
...
const int XCB_SELECTION_REQUEST = 30;
...
const int XCB_SELECTION_NOTIFY = 31;
...
const int XCB_COLORMAP_NOTIFY = 32;
...
const int XCB_CLIENT_MESSAGE = 33;
...
const int XCB_MAPPING_NOTIFY = 34;
...
const int XCB_CHANGE_WINDOW_ATTRIBUTES = 2;
...
const int XCB_GET_WINDOW_ATTRIBUTES = 3;
...
const int XCB_DESTROY_WINDOW = 4;
...
const int XCB_DESTROY_SUBWINDOWS = 5;
...
const int XCB_CHANGE_SAVE_SET = 6;
...
const int XCB_REPARENT_WINDOW = 7;
...
const int XCB_MAP_SUBWINDOWS = 9;
...
const int XCB_UNMAP_SUBWINDOWS = 11;
...
const int XCB_CONFIGURE_WINDOW = 12;
...
const int XCB_CIRCULATE_WINDOW = 13;
...
const int XCB_GET_ATOM_NAME = 17;
...
const int XCB_CHANGE_PROPERTY = 18;
...
const int XCB_DELETE_PROPERTY = 19;
...
const int XCB_LIST_PROPERTIES = 21;
...
const int XCB_SET_SELECTION_OWNER = 22;
...
const int XCB_GET_SELECTION_OWNER = 23;
...
const int XCB_CONVERT_SELECTION = 24;
...
const int XCB_UNGRAB_POINTER = 27;
...
const int XCB_UNGRAB_BUTTON = 29;
...
const int XCB_CHANGE_ACTIVE_POINTER_GRAB = 30;
...
const int XCB_GRAB_KEYBOARD = 31;
...
const int XCB_UNGRAB_KEYBOARD = 32;
...
const int XCB_UNGRAB_SERVER = 37;
...
const int XCB_QUERY_POINTER = 38;
...
const int XCB_GET_MOTION_EVENTS = 39;
...
const int XCB_TRANSLATE_COORDINATES = 40;
...
const int XCB_SET_INPUT_FOCUS = 42;
...
const int XCB_GET_INPUT_FOCUS = 43;
...
const int XCB_QUERY_TEXT_EXTENTS = 48;
...
const int XCB_LIST_FONTS_WITH_INFO = 50;
...
const int XCB_SET_FONT_PATH = 51;
...
const int XCB_GET_FONT_PATH = 52;
...
const int XCB_CREATE_PIXMAP = 53;
...
const int XCB_SET_CLIP_RECTANGLES = 59;
...
const int XCB_POLY_RECTANGLE = 67;
...
const int XCB_POLY_FILL_RECTANGLE = 70;
...
const int XCB_POLY_FILL_ARC = 71;
...
const int XCB_IMAGE_TEXT_16 = 77;
...
const int XCB_CREATE_COLORMAP = 78;
...
const int XCB_FREE_COLORMAP = 79;
...
const int XCB_COPY_COLORMAP_AND_FREE = 80;
...
const int XCB_INSTALL_COLORMAP = 81;
...
const int XCB_UNINSTALL_COLORMAP = 82;
...
const int XCB_LIST_INSTALLED_COLORMAPS = 83;
...
const int XCB_ALLOC_NAMED_COLOR = 85;
...
const int XCB_ALLOC_COLOR_CELLS = 86;
...
const int XCB_ALLOC_COLOR_PLANES = 87;
...
const int XCB_STORE_NAMED_COLOR = 90;
...
const int XCB_CREATE_CURSOR = 93;
...
const int XCB_CREATE_GLYPH_CURSOR = 94;
...
const int XCB_RECOLOR_CURSOR = 96;
...
const int XCB_QUERY_BEST_SIZE = 97;
...
const int XCB_QUERY_EXTENSION = 98;
...
const int XCB_LIST_EXTENSIONS = 99;
...
const int XCB_CHANGE_KEYBOARD_MAPPING = 100;
...
const int XCB_GET_KEYBOARD_MAPPING = 101;
...
const int XCB_CHANGE_KEYBOARD_CONTROL = 102;
...
const int XCB_GET_KEYBOARD_CONTROL = 103;
...
const int XCB_CHANGE_POINTER_CONTROL = 105;
...
const int XCB_GET_POINTER_CONTROL = 106;
...
const int XCB_SET_SCREEN_SAVER = 107;
...
const int XCB_GET_SCREEN_SAVER = 108;
...
const int XCB_CHANGE_HOSTS = 109;
...
const int XCB_SET_ACCESS_CONTROL = 111;
...
const int XCB_SET_CLOSE_DOWN_MODE = 112;
...
const int XCB_ROTATE_PROPERTIES = 114;
...
const int XCB_FORCE_SCREEN_SAVER = 115;
...
const int XCB_SET_POINTER_MAPPING = 116;
...
const int XCB_GET_POINTER_MAPPING = 117;
...
const int XCB_SET_MODIFIER_MAPPING = 118;
...
const int XCB_GET_MODIFIER_MAPPING = 119;
...
const int XCB_NO_OPERATION = 127;
